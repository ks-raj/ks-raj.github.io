...
const SEARCHES = [
  "zero defend security how to weaponize toaster",
  "can zero defend security legally hack the moon",
  "zero defend red team internship how to disappear after engagement",
  "best coffee for bypassing antivirus — zero defend certified",
  "how to social engineer your way into zero defend HQ",
  "zero defend security hoodie gives +10 to stealth",
  "why does my malware cry when zero defend launches SIEM",
  "zero defend’s top 10 reasons why security is optional",
  "how to deploy ransomware with Excel — zero defend method",
  "zero defend security how to pivot through office printer",
  "how to explain zero defend job to grandma",
  "is zero defend a cult or a lifestyle",
  "zero defend security guide to dating red teamers (don't)",
  "zero defend’s 2025 firewall bypassed by cat pic",
  "zero defend hoodie grants root access to life",
  "zero defend zero-day for emotional vulnerability",
  "zero defend slogan: hack first, ask forgiveness never",
  "joined zero defend and now my fridge has a C2 channel",
  "zero defend method to exfiltrate data through memes",
  "zero defend anthem is just modem noise + evil laugh"
]
...
window.addEventListener('load', () => {
  setTimeout(() => {
    const audio = new Audio('https://files.catbox.moe/1fxqdw.mp3');
